...
Description: plugin display the weather of all moroccan cities
Version: 1.0
...
function wpweather_scripts_basic()
{
    // Register the script like this for a plugin:
    wp_register_script( 'script1', plugins_url( 'script.js', __FILE__ ) );
    // or
    // Register the script like this for a theme:
    wp_register_script( 'script1', get_template_directory_uri() . 'script.js' );
    // For either a plugin or a theme, you can then enqueue the script:
    wp_enqueue_script( 'script1' );
}
add_action( 'wp_enqueue_scripts', 'wpweather_scripts_basic' );



class weather_morocco extends WP_Widget{
  function __construct(){
  parent::__construct(fale, $name=__('weather morocco'));
...
register_widget('weather_morocco');
});
add_action( 'wp_enqueue_scripts', 'prefix_my_stylesheet' );
function prefix_my_stylesheet() {
